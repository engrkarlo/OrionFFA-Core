...
public final class FfaService {
    ...
    public ServiceResult leaveToLobby(Player player){
        // If this player is the target of an active spectator, return those spectators first.
        // This is also used by death recovery, /offa lobby, and normal arena exits, so target
        // loss is handled consistently regardless of how the target leaves the arena.
